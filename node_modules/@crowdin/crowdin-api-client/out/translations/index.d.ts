...
export declare class Translations extends CrowdinApi {
     ...
     * @param request request body
     */
    buildProjectFileTranslation(projectId: number, fileId: number, request: TranslationsModel.BuildProjectFileTranslationRequest): Promise<ResponseObject<DownloadLink>>;
    /**
     * @param projectId project identifier
     ...
     * @param request request body
     */
    uploadTranslation(projectId: number, languageId: string, request: TranslationsModel.UploadTranslationRequest): Promise<void>;
}
