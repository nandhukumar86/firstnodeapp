...
export declare class SourceFiles extends CrowdinApi {
     ...
     * @param request request body
     */
    updateOrRestoreFile(projectId: number, fileId: number, request: SourceFilesModel.UpdateOrRestoreFileRequest): Promise<ResponseObject<SourceFilesModel.File>>;
    /**
     * @param projectId project identifier
     * @param fileId file identifier
     */
...
export declare namespace SourceFilesModel {
    ...
    interface UpdateOrRestoreFileRequest {
        storageId: number;
