...
class StringTranslations extends core_1.CrowdinApi {
     ...
     */
    listTranslationApprovals(projectId, stringId, languageId, translationId, limit, offset) {
     ...
     * @param offset starting offset in the collection (default 0)
     */
    listLanguageTranslations(projectId, languageId, stringIds, fileId, limit, offset) {
     ...
     * @param offset starting offset in the collection (default 0)
     */
    listStringTranslations(projectId, stringId, languageId, limit, offset) {
